...
const App: React.FC = () => {
  ...
  return (
    <ErrorBoundary>
      <Helmet>
        <title>PARSS - Penalty Avoidance & Regulatory Survival System</title>
        <meta name="description" content="Prevent ₹10L–₹2Cr penalties with continuous compliance monitoring and regulatory survival systems" />
